package br.com.pagamentos_api.kafka.producers.config;
...
public class GenericProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, Object> produtorFactory() {
        Map<String, Object> propriedades = new HashMap<>();
        propriedades.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, servidoresBootstrap);
